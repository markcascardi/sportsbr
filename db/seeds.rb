...
baseball = Sport.create(name: "Baseball", gender: "Men's")
Sport.create(name: "Basketball", gender: "Men's")
Sport.create(name: "Football", gender: "Men's")
Sport.create(name: "Golf", gender: "Men's")
Sport.create(name: "Lacrosse", gender: "Men's")
Sport.create(name: "Soccer", gender: "Men's")
Sport.create(name: "Tennis", gender: "Men's")
Sport.create(name: "Track & Field", gender: "Men's")
Sport.create(name: "Wrestling", gender: "Men's")
Sport.create(name: "Basketball", gender: "Women's")
Sport.create(name: "Field Hockey", gender: "Women's")
Sport.create(name: "Golf", gender: "Women's")
Sport.create(name: "Lacrosse", gender: "Women's")
Sport.create(name: "Rowing", gender: "Women's")
Sport.create(name: "Soccer", gender: "Women's")
Sport.create(name: "Softball", gender: "Women's")
Sport.create(name: "Tennis", gender: "Women's")
Sport.create(name: "Track & Field", gender: "Women's")
Sport.create(name: "Volleyball", gender: "Women's")

baseball2019 = Team.create(sport_id: baseball.id, season_id: s2019.id)
